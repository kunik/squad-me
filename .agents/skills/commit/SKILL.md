...
4. **Infrastructure docs gate** — if the change set includes any of:
   - `wrangler.jsonc` / Wrangler env or bindings
   - `infra-setup/*` or other infra bootstrap scripts
   ...
   If infra files changed but those docs did not, **stop**: do not commit.
